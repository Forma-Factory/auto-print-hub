                ...
                >
                  <div className={`relative h-48 overflow-hidden ${(feature.title === "Gestione Coda Intelligente" || feature.title === "Gestione Multi-Stampante" || feature.title === "Monitoraggio Live" || feature.title === "Piattaforma Didattica") ? "bg-slate-900 p-4" : ""}`}>
                    <img 
                      ...
                      className={`w-full h-full ${(feature.title === "Gestione Coda Intelligente" || feature.title === "Gestione Multi-Stampante" || feature.title === "Monitoraggio Live" || feature.title === "Piattaforma Didattica") ? "object-contain" : "object-cover"} group-hover:scale-110 transition-transform duration-700`}
                    />
